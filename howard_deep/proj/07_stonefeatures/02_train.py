...
class MapModel:
    ...
    def build_model(self):
        ...
        x = kl.Dense(64, activation='relu', name='dense_0')(x)
        x = kl.BatchNormalization()(x)
        x = kl.Dense(64, activation='relu', name='dense_1')(x)
        x = kl.BatchNormalization()(x)
        x = kl.Dense(64, activation='relu', name='dense_2')(x)
        x = kl.BatchNormalization()(x)
        x = kl.Dense(64, activation='softmax', name='dense_3')(x)
        x = kl.BatchNormalization()(x)
