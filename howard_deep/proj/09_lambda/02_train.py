...
class LambdaModel:
    ...
    def build_model(self):
        ...
        x = kl.Conv2D(32,(3,3), activation='selu', padding='same')(inputs)
        x = kl.Conv2D(32,(3,3), activation='selu', padding='same')(x)
        x = kl.MaxPooling2D()(x)
        x = kl.Conv2D(64,(3,3), activation='selu', padding='same')(x)
        x = kl.Conv2D(64,(3,3), activation='selu', padding='same')(x)
        x = kl.MaxPooling2D()(x)
